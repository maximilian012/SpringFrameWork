...
public class MemberServiceImpl implements MemberService{
	...
	public String getAccessToken(String authorize_code) {
		...
		try {
			...
			sb.append("&client_id=fd94cd67004fb7afe22bd9bb5dbbe7ed"); //본인이 발급받은 key
			sb.append("&redirect_uri=http://localhost:8100/SpringSamples/kakaoLogin.do"); // 본인이 설정한 주소
	...
	@Override
	public void setAttribute(String string, String k_name) {
		// TODO Auto-generated method stub
